...
const Dashboard = {
                ...
                <div class="kpi-card">
                    ...
                    <div class="kpi-content">
                        ...
                        <div class="kpi-change">
                            Base nos últimos registros aprovados
                        </div>
                    </div>
                </div>
                <div class="kpi-card">
        ...
        return `
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        ${pending.map(sol => {
                            const referenceDate = sol.createdAt || (sol.data ? new Date(sol.data).getTime() : null) || Date.now();
                ...
                ${topTechs.map(t => `
                    <div class="top-tech-item">
                        <div>
                            ...
                            <div class="meta">${Utils.formatNumber(t.count || 0)} solicitações</div>
                        </div>
                        <div style="text-align: right;">
                            <div class="meta">Em aberto: ${Utils.formatCurrency(t.pending || 0)}</div>
    ...
    clearRecentFilters() {
        ...
        if (document.getElementById('recent-search')) document.getElementById('recent-search').value = '';
        if (document.getElementById('recent-status')) document.getElementById('recent-status').value = '';
        if (document.getElementById('recent-tecnico')) document.getElementById('recent-tecnico').value = '';
        if (document.getElementById('recent-date-from')) document.getElementById('recent-date-from').value = '';
        if (document.getElementById('recent-date-to')) document.getElementById('recent-date-to').value = '';
        this.refreshRecentTable();
    },
