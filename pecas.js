...
const Pecas = {
    ...
    savePart() {
        ...
        const codigo = document.getElementById('part-codigo').value.trim();
        const descricao = document.getElementById('part-descricao').value.trim();
        const categoria = document.getElementById('part-categoria').value;
        const valor = parseFloat(document.getElementById('part-valor').value);
        const unidade = document.getElementById('part-unidade').value;
    ...
    handleItemClick(event, index) {
        ...
        const container = document.getElementById(dropdown._containerId);
