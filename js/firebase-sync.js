...
// Path in the Realtime Database where application state is stored.  Use a
// project‑specific namespace (dashboard‑pecas) instead of the previous
// diversey‑solicitacoes‑pwa path. Updating this constant aligns with the
// Firebase rules and ensures that state is written to the correct node.
const PATH = 'apps/dashboard-pecas/state';
