...
export async function ensureLoaded() {
    ...
    await ensureClassicScript(new URL('../solicitacoes.js?v=20260311b', import.meta.url).href, 'Solicitacoes');
    await ensureClassicScript(new URL('../aprovacoes.js?v=20260311b', import.meta.url).href, 'Aprovacoes');
