...
export async function ensureLoaded() {
    ...
    await ensureClassicScript(new URL('../solicitacoes.js?v=20260311d', import.meta.url).href, 'Solicitacoes');
    await ensureClassicScript(new URL('../aprovacoes.js?v=20260311d', import.meta.url).href, 'Aprovacoes');
